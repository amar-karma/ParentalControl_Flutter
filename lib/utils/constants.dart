...
const COLOR_PINK = Color.fromRGBO(248, 203, 219, 1.0);
const COLOR_BLUE = Color.fromRGBO(45, 130, 254, 1.0);
const COLOR_ORANGE = Color.fromRGBO(255, 158, 87, 1.0);
const COLOR_GREEN = Color.fromRGBO(97, 241, 143, 1.0);
const COLOR_DARK_GREEN = Color.fromRGBO(12, 135, 34, 1.0);
const COLOR_LIGHT = Color.fromRGBO(228, 239, 255, 1.0);
